...
public class GiantHideoutPiece extends BaseStructurePiece{
    ...
    protected GiantHideoutPiece(Either<ResourceLocation, StructureTemplate> template, InteractionResultHolder<StructureProcessorList> processors, StructureTemplatePool.Projection projection) {
