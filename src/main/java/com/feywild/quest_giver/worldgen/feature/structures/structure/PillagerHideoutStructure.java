...
public class PillagerHideoutStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public static boolean isFeatureChunk(StructureStart<JigsawConfiguration> context) {
        ChunkPos chunkpos = (ChunkPos) context.getPieces();
        return !context.chunkGenerator().hasFeatureChunkInRange(VILLAGE, context.seed(),
